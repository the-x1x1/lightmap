...
export function OfflineState() {
  ...
  return (
    <div role="status" className="fixed left-1/2 top-2 z-50 -translate-x-1/2 rounded-full bg-[var(--lm-panel-raised)] px-3 py-1.5 text-xs text-[var(--lm-text)] ring-1 ring-white/15">
