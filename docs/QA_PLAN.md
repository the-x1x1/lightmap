...
| Web unit                  | `apps/web/tests/unit/{store,timeline,use-scene}.test.ts`                | Planner store transitions (wall-clock preserved across zones, restore of saved viewpoint, force-scenario); timeline minute/marker math; `useScene` composition with fake providers.                                                                                                                                                                                                                                                                                                   |
